...
get "/" do
  "This is the doctor_teeth ETL server, i know you are excited!<br>" \
    ...
    "There are optional query parameters for 'project', 'configuration'" \
    " and 'execution_id'<br>" \
    "<p>" \
...
#     --data-binary @fixtures/beaker_junit_01.xml localhost:4567/junit
#   note the header is required so sinatra doesn't try to
#     parse form params out of the data
post "/junit" do
  ...
  DoctorTeeth.parse(datablob, configuration: {})
end
